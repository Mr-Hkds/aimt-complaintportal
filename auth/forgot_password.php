            ...
            <form method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div style="position:relative;">
                        ...
                        <span class="material-icons" id="toggleConfirmPassword"
                            style="position:absolute;top:50%;right:0.75rem;transform:translateY(-50%);cursor:pointer;user-select:none;">visibility_off</span>
                    </div>
                </div>
                <script>
        ...
        <?php elseif (!$success): ?>
            <form method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="phone" name="phone" required placeholder="Enter your registered mobile number"
                        value="<?= htmlspecialchars($phone) ?>" maxlength="10"
