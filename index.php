    ...
    <section class="hero-pattern text-white relative py-20 fade-in-hero">
        ...
        <div class="container mx-auto px-4 relative">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-xl text-blue-100 mb-12">Your voice matters – Report, Track, and Resolve campus issues
                    easily.</p>
                <div class="flex gap-6 justify-center">
                    <a href="auth/login.php"
                        class="action-button px-8 py-3 rounded-lg text-white font-medium inline-flex items-center gap-2">
                        <i class="lucide-log-in"></i>
                        Login
                    </a>
                    <a href="auth/register.php"
                        class="bg-white/10 backdrop-blur-sm px-8 py-3 rounded-lg text-white font-medium hover:bg-white/20 transition-all inline-flex items-center gap-2">
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="feature-card rounded-2xl p-6 shadow-lg">
                    ...
                    <p class="text-slate-600">Instantly raise issues like Wi-Fi, Mess, Electrician, and more through our
                        streamlined system.</p>
                </div>
                ...
                <div class="feature-card rounded-2xl p-6 shadow-lg">
                    ...
                    <p class="text-slate-600">Use unique QR codes to view real-time updates on your complaint status.
                    </p>
                </div>
                ...
                <div class="feature-card rounded-2xl p-6 shadow-lg">
                    ...
                    <p class="text-slate-600">Share your ideas to improve campus life! Submit new suggestions or vote on
                        others' ideas to make your voice heard.</p>
                </div>
                ...
                <div class="feature-card rounded-2xl p-6 shadow-lg">
                    ...
                    <p class="text-slate-600">Dedicated technicians scan QR codes and provide swift resolution to your
                        issues.</p>
                </div>
    ...
    <footer class="bg-slate-900 text-white py-8">
        <div class="container mx-auto px-4">
            <div class="text-center">
                ...
                <p class="text-slate-400 mb-1">Plot M-1, Pocket P-5, Greater Noida, Gautam Buddha Nagar (UP) - 201310
                </p>
                <div class="w-24 h-1 bg-blue-500 mx-auto my-4"></div>
                <p class="text-sm text-slate-500">Student-Built Solutions for the Campus.</p>
            </div>
        </div>
    </footer>
