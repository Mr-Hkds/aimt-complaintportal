...
<body class="bg-gray-50 dark:bg-dark-bg-primary min-h-screen font-['Inter'] transition-colors duration-200">
    ...
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <aside id="sidebar"
            class="fixed md:static inset-y-0 left-0 transform -translate-x-full md:translate-x-0 z-[55] w-64 bg-gradient-to-b from-blue-800 to-blue-900 text-white flex flex-col transition-transform duration-200 ease-in-out shadow-xl">
            ...
            <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                ...
                <a href="submit_complaint.php"
                    class="flex items-center px-4 py-3 rounded-lg hover:bg-green-700/50 dark:hover:bg-green-800/50 transition-colors group">
                ...
                <button id="help-button" type="button"
                    class="flex items-center w-full px-4 py-3 rounded-lg hover:bg-blue-700/50 dark:hover:bg-blue-800/50 transition-colors group">
        ...
        <main id="main-content"
            class="flex-1 flex flex-col w-0 md:w-auto md:ml-0 transition-all duration-200 overflow-hidden">
            <!-- Header -->
            <header class="sticky top-0 z-40 bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg">
                <div class="flex items-center justify-between px-4 py-3">
                    <!-- Mobile Menu Button -->
                    <button id="mobile-menu-button"
                        class="md:hidden p-2 rounded-lg text-white hover:bg-white/20 touch-target">
                    ...
                    <div class="flex items-center space-x-3 flex-1 md:flex-none mx-2">
                        <img src="<?= BASE_URL ?>assets/images/aimt-logo.png" alt="AIMT Logo"
                            class="w-8 h-8 md:w-10 md:h-10 bg-white p-1 rounded-lg shadow-lg">
                        <div class="min-w-0">
                            <h1 class="text-base sm:text-lg md:text-xl font-bold truncate">Technician Dashboard</h1>
                            <p class="hidden md:block text-sm text-blue-100">Welcome back,
                                <?= htmlspecialchars($_SESSION['full_name'] ?? 'Technician') ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        <a href="scanner.php"
                            class="touch-target bg-white/20 hover:bg-white/30 text-white px-3 py-2 rounded-lg transition-colors flex items-center space-x-2 qr-glow">
            ...
            <div class="flex-1 overflow-y-auto mobile-scrollable">
                <div class="p-4 md:p-6 space-y-6 mobile-spacing-y">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                        <!-- Total Complaints -->
                        <div
                            class="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm border border-gray-200 dark:border-dark-border p-4 md:p-6 card-hover">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm font-medium text-gray-600 dark:text-dark-text-secondary">Total
                                        Complaints</p>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm font-medium text-gray-600 dark:text-dark-text-secondary">Pending
                                    </p>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm font-medium text-gray-600 dark:text-dark-text-secondary">Admin
                                        Assigned</p>
                                ...
                                <div class="p-2 md:p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg">
                                    <span
                                        class="material-icons text-purple-600 dark:text-purple-400">admin_panel_settings</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm font-medium text-gray-600 dark:text-dark-text-secondary">
                                        Completion Rate</p>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <!-- Active Complaints -->
                        <div
                            class="lg:col-span-2 bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm border border-gray-200 dark:border-dark-border">
                            ...
                            <div class="p-2 md:p-6">
                                <?php if (!empty($complaints)): ?>
                                    <div
                                        class="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm border border-gray-200 dark:border-dark-border overflow-hidden">
                                        <!-- Mobile-optimized complaint list -->
                                        <div
                                            class="divide-y divide-gray-200 dark:divide-dark-border max-h-96 overflow-y-auto mobile-scrollable">
                                            <?php
                                            ...
                                            foreach ($active_complaints as $complaint):
                                                ...
                                                <div class="p-4 md:p-6 hover:bg-gray-50 dark:hover:bg-dark-bg-primary transition-colors
                                                    ...
                                                    <div
                                                        class="grid grid-cols-1 md:grid-cols-5 gap-3 md:gap-4 mobile-complaint-info">
                                                        <!-- User Column -->
                                                        <div class="md:col-span-1">
                                                            <div class="flex items-center space-x-3">
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="material-icons text-blue-600 dark:text-blue-400 text-lg">person</span>
                                                                </div>
                                                                <div class="min-w-0 flex-1">
                                                                    ...
                                                                    <div class="flex flex-wrap items-center gap-1 mt-1">
                                                                        <span
                                                                            class="inline-block px-2 py-0.5 text-xs font-medium rounded bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-200"
                                                                            style="letter-spacing:0.2px;">
                                                                            Room <?= htmlspecialchars($complaint['room_no']) ?>
                                                                        </span>
                                                                        <?php if (!empty($complaint['hostel_type'])): ?>
                                                                            <span
                                                                                class="inline-block px-2 py-0.5 text-xs font-medium rounded bg-gray-100 text-gray-700 dark:bg-gray-800/50 dark:text-gray-200 capitalize"
                                                                                style="letter-spacing:0.2px;">
                                                        ...
                                                        <div class="md:col-span-1">
                                                            <div class="space-y-1">
                                                                ...
                                                                <p class="text-xs text-gray-500 dark:text-dark-text-secondary">
                                                                    ...
                                                                    <?= date('M j, g:i A', strtotime($complaint['created_at'])) ?>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="md:col-span-1">
                                                            <p
                                                                class="text-sm text-gray-900 dark:text-dark-text-primary font-medium capitalize">
                                                        ...
                                                        <div class="md:col-span-1">
                                                            <?php if ($complaint['assignment_type'] === 'admin_assigned'): ?>
                                                                <span
                                                                    class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400 animate-pulse">
                                                            ...
                                                            <div class="space-y-2">
                                                                <span class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full
                                                                    ...
                                                                    switch ($complaint['status']) {
                                                                        case 'pending':
                                                                            echo 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400';
                                                                            break;
                                                                        case 'in_progress':
                                                                            echo 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400';
                                                                            break;
                                                                        default:
                                                                            echo 'bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400';
                                                                    }
                                                                    ?>">
                                                                    <?= ucfirst(str_replace('_', ' ', $complaint['status'])) ?>
                                                                </span>
                                                                <button
                                                                    onclick="viewComplaintDetails('<?= $complaint['token'] ?>')"
                        ...
                        <div class="space-y-6">
                            <!-- Quick Actions -->
                            <div
                                class="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm border border-gray-200 dark:border-dark-border p-6">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-dark-text-primary mb-4">Quick
                                    Actions</h3>
                                <div class="space-y-3">
                                    <a href="scanner.php"
                                        class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg font-medium transition-colors flex items-center justify-center space-x-2 qr-glow">
                                        <span class="material-icons">qr_code_scanner</span>
                                        <span>Scan QR Code</span>
                                    </a>
                                    <a href="complaints.php"
                                        class="w-full bg-gray-100 dark:bg-dark-border hover:bg-gray-200 dark:hover:bg-dark-bg-primary text-gray-700 dark:text-dark-text-primary px-4 py-3 rounded-lg font-medium transition-colors flex items-center justify-center space-x-2">
                            ...
                            <div
                                class="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm border border-gray-200 dark:border-dark-border p-6">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-dark-text-primary mb-4">Recent
                                    Activity</h3>
                            ...
                            <?php if ($urgent_issue): ?>
                                <div class="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-lg">
                                    <marquee behavior="scroll" direction="left" scrollamount="8"
                                        class="bg-red-600 text-white font-bold py-2 px-4 rounded-xl shadow-lg border-2 border-red-800 animate-pulse">
                                        🚨 URGENT: Hostel-wide issue
                                        (<?= htmlspecialchars(ucfirst($urgent_issue['issue_type'])) ?>,
                                        <?= htmlspecialchars(ucfirst($urgent_issue['hostel_type'])) ?> Hostel) has reached
                                        15+ votes! Immediate attention required!
                                    </marquee>
                                </div>
                            <?php endif; ?>
                            <div
                                class="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm border border-gray-200 dark:border-dark-border p-6">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-dark-text-primary mb-4">Hostel
                                    Issues</h3>
                                <?php if (empty($hostel_issues)): ?>
                                    <p class="text-gray-500 dark:text-dark-text-secondary text-sm">No active hostel issues
                                    </p>
                                <?php else: ?>
                                    <div class="space-y-3">
                                        <?php foreach (array_slice($hostel_issues, 0, 5) as $issue): ?>
                                            <div class="border border-gray-200 dark:border-dark-border rounded-lg p-3">
                                                ...
                                                <div class="text-xs text-gray-500 dark:text-dark-text-secondary">
                                                    <p><?= ucfirst(htmlspecialchars($issue['hostel_type'])) ?> Hostel •
                                                        <?= $issue['votes'] ?> votes</p>
                                    ...
                                    <?php if (count($hostel_issues) > 5): ?>
                                        <a href="hostel_issues.php"
                                            class="text-blue-600 dark:text-blue-400 text-sm font-medium hover:underline mt-3 inline-block">
    ...
    <div id="complaint-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden">
        <div class="flex items-center justify-center min-h-screen p-2 md:p-4">
            <div
                class="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-xl w-full max-w-md max-h-[95vh] md:max-h-[90vh] overflow-y-auto">
                <div class="p-4 md:p-6 border-b border-gray-200 dark:border-dark-border">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-dark-text-primary">Complaint Details
                        </h3>
