        ...
        <div class="complaint-modal-container">
            ...
            <div class="complaint-modal-content">
                ...
                <div class="form-group">
                    <label for="tech-remark">Work Performed / Notes <span
                            style="color:#94a3b8;font-size:0.8rem;">(Optional)</span></label>
                    <textarea id="tech-remark" placeholder="Add any notes about the work performed..."
                        rows="4"></textarea>
                </div>
