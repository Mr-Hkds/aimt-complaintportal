...
<body class="bg-gray-50 dark:bg-dark-bg-primary min-h-screen font-['Inter'] transition-colors duration-200">
    <div class="flex min-h-screen">
        ...
        <div id="sidebar-backdrop"
            class="fixed inset-0 bg-black bg-opacity-30 z-[54] hidden md:hidden transition-opacity"></div>

        <!-- Sidebar -->
        <aside id="sidebar"
            class="fixed md:static inset-y-0 left-0 transform -translate-x-full md:translate-x-0 z-[55] w-64 bg-gradient-to-b from-blue-800/95 to-blue-900/95 dark:from-blue-900/95 dark:to-blue-950/95 backdrop-blur-md border-r border-white/10 text-white flex flex-col transition-transform duration-200 ease-in-out shadow-2xl md:shadow-xl">
            <div
                class="px-6 py-6 bg-gradient-to-r from-blue-700 to-blue-800 dark:from-blue-800 dark:to-blue-900 mt-4 md:mt-0">
                <div class="flex items-center space-x-3">
                    <img src="<?= BASE_URL ?>assets/images/aimt-logo.png" alt="AIMT Logo"
                        class="w-10 h-10 bg-white p-1 rounded-lg shadow-md">
            ...
            <div
                class="px-6 py-4 border-b border-blue-700/50 dark:border-blue-800/50 bg-blue-800/30 dark:bg-blue-900/30">
            ...
            <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                <a href="dashboard.php"
                    class="flex items-center px-4 py-3 rounded-lg bg-blue-700/50 dark:bg-blue-800/50 hover:bg-blue-700 dark:hover:bg-blue-800 transition-colors group">
                    <span class="material-icons mr-3 text-blue-200">dashboard</span>
                    <span>Dashboard</span>
                </a>
                <a href="submit_complaint.php"
                    class="flex items-center px-4 py-3 rounded-lg hover:bg-blue-700/50 dark:hover:bg-blue-800/50 transition-colors group">
                ...
                <button id="help-button"
                    class="flex items-center w-full px-4 py-3 rounded-lg hover:bg-blue-700/50 dark:hover:bg-blue-800/50 transition-colors group mt-2">
                    <span class="material-icons mr-3 text-blue-200">help</span>
                    <span>Help Guide</span>
                </button>
                <a href="../auth/logout.php"
                    class="flex items-center px-4 py-3 rounded-lg hover:bg-red-500/10 text-red-100 transition-colors group mt-auto">
        ...
        <main id="main-content" class="flex-1 flex flex-col w-0 md:w-auto md:ml-0 transition-all duration-200">
            <!-- Header -->
            <header
                class="sticky top-0 z-50 backdrop-blur-md bg-gradient-to-r from-blue-600/90 to-indigo-700/90 dark:from-blue-800/90 dark:to-indigo-900/90 text-white shadow-xl">
                <div class="flex items-center justify-between px-4 py-4 md:px-6 md:py-6">
                    <div class="flex items-center space-x-4">
                        <!-- Mobile Menu Button -->
                        <button id="mobile-menu-button"
                            class="md:hidden p-2 -ml-2 rounded-lg hover:bg-blue-700/50 transition-colors">
                            <span class="material-icons">menu</span>
                        </button>
                        <img src="../assets/images/aimt-logo.png" alt="AIMT Logo"
                            class="w-10 h-10 md:w-12 md:h-12 bg-white p-1 rounded-lg shadow-lg">
                        <div class="flex flex-col leading-tight">
                            <h1 class="text-xl md:text-2xl font-bold">Dashboard</h1>
                            <span class="text-xs md:text-sm text-blue-200">Welcome,
                                <?= htmlspecialchars($_SESSION['full_name'] ?? 'User') ?></span>
                        </div>
                    </div>
                    <!-- Notification Bell -->
                    <button id="notification-bell"
                        class="relative bg-gray-200 dark:bg-dark-bg-secondary text-gray-800 dark:text-dark-text-primary p-2 rounded-lg shadow-lg hover:bg-gray-300 dark:hover:bg-dark-border transition-colors">
                        <span class="material-icons">notifications</span>
                        <span id="notification-badge"
                            class="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full px-1 hidden"></span>
                    </button>
                    <!-- Notification Dropdown -->
                    <div id="notification-dropdown"
                        class="hidden absolute top-16 right-4 bg-white dark:bg-dark-bg-secondary rounded-xl shadow-lg w-80 max-w-xs z-[101] border border-gray-200 dark:border-dark-border">
                        <div
                            class="p-4 border-b border-gray-100 dark:border-dark-border font-semibold flex justify-between items-center">
                            <span>Notifications</span>
                            <button id="delete-all-notifications"
                                class="text-red-500 hover:text-red-700 text-sm flex items-center"
                                title="Delete All Notifications" onclick="deleteAllNotifications()">
            ...
            <div class="flex-1 p-4 md:p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div
                        class="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm hover:shadow-md transition-shadow p-4">
                        <div class="flex items-center justify-between">
                            <div class="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
                                <span class="material-icons text-xl text-blue-600 dark:text-blue-400">description</span>
                            </div>
                            <span
                                class="text-2xl font-bold text-gray-800 dark:text-dark-text-primary"><?= $total ?></span>
                        </div>
                        <h3 class="mt-2 text-sm text-gray-600 dark:text-dark-text-secondary font-medium">Total
                            Complaints</h3>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div class="p-2 bg-green-100 dark:bg-green-900/30 rounded-lg">
                                <span
                                    class="material-icons text-xl text-green-600 dark:text-green-400">check_circle</span>
                            </div>
                            <span
                                class="text-2xl font-bold text-gray-800 dark:text-dark-text-primary"><?= $resolved ?></span>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="text-2xl font-bold text-gray-800 dark:text-dark-text-primary"><?= $pending ?></span>
                        </div>
                ...
                <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'student' && !empty($hostel_issues)): ?>
                    <div class="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm overflow-hidden">
                        <div class="p-4 border-b border-gray-100 dark:border-dark-border">
                            <h2 class="text-lg font-semibold text-gray-800 dark:text-dark-text-primary">Hostel-Wide
                                Complaints</h2>
                            <p class="mt-1 text-sm text-gray-600 dark:text-dark-text-secondary">
                                Active issues for <?= htmlspecialchars($hostel_types[$student_hostel] ?? $student_hostel) ?>
                                Hostel
                            </p>
                        </div>
                        <div class="overflow-x-auto">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <?php foreach ($hostel_issues as $issue): ?>
                                    <div
                                        class="relative bg-white dark:bg-dark-bg-secondary border border-gray-100 dark:border-dark-border rounded-2xl shadow-lg hover:shadow-2xl hover:-translate-y-1 transition p-5 flex flex-col space-y-3">
                                        <span
                                            class="absolute top-4 right-4 px-2 py-0.5 rounded-full text-xs font-bold
                                    <?= $issue['status'] === 'resolved' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-800' :
                                        ...
                                        <div class="flex items-center space-x-3">
                                            <div class="bg-red-50 dark:bg-red-900/30 rounded-full p-2">
                                                <span
                                                    class="material-icons text-red-500 dark:text-red-300 text-2xl">campaign</span>
                                            </div>
                                            <div>
                                                <div class="text-lg font-semibold text-gray-900 dark:text-dark-text-primary">
                                                    <?= htmlspecialchars($issue_types[$issue['issue_type']] ?? $issue['issue_type']) ?>
                                                </div>
                                                <div class="text-xs text-gray-400 dark:text-dark-text-secondary">Votes: <span
                                                        class="font-bold"><?= $issue['votes'] ?></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-2">
                                            <?php if ($issue['user_voted'] == 0): ?>
                                                <button type="button"
                                                    ...
                                                    <span class="material-icons text-base mr-1">thumb_up</span>Yes, I have this
                                                    issue too
                                                </button>
                                            <?php else: ?>
                                                <span
                                                    class="flex items-center text-green-700 dark:text-green-400 text-sm font-medium">
                ...
                <div class="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm overflow-hidden">
                    <div class="p-4 border-b border-gray-100 dark:border-dark-border">
                        <h2 class="text-lg font-semibold text-gray-800 dark:text-dark-text-primary">Recent Complaints
                        </h2>
                    </div>
                    <?php if ($complaints): ?>
                        <div class="overflow-x-auto">
                                ...
                                <?php foreach ($complaints as $c): ?>
                                    ...
                                    <?= $c['status'] === 'resolved' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-800' :
                                        ...
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <div class="text-lg font-semibold text-gray-900 dark:text-dark-text-primary">
                                                    <?= htmlspecialchars(ucfirst($c['category'])) ?></div>
                                                <div class="text-xs text-gray-400 dark:text-dark-text-secondary">Token:
                                                    <?= htmlspecialchars($c['token']) ?></div>
                                            </div>
                                        </div>
                                        <div
                                            class="flex flex-col text-sm text-gray-500 dark:text-dark-text-secondary space-y-1">
                                            <span>Created:
                                                <?= htmlspecialchars(date('M j, Y', strtotime($c['created_at']))) ?></span>
                                            <span>Updated:
                                                <?= htmlspecialchars(date('M j, Y', strtotime($c['updated_at']))) ?></span>
                                        </div>
                                        <div class="flex items-center text-sm technician-status">
                                            <?php if ($c['tech_name']): ?>
                                                <div class="flex flex-col space-y-1">
                                                    <div class="flex items-center">
                                                        <span class="text-gray-500 dark:text-dark-text-secondary mr-2">Assigned
                                                            Technician:</span>
                                                        <span
                                                            class="font-medium text-gray-800 dark:text-dark-text-primary tech-name"><?= htmlspecialchars($c['tech_name']) ?></span>
                                                    </div>
                                                    ...
                                                    <?php if ($c['tech_phone']): ?>
                                                        <div class="flex items-center">
                                                            <a href="tel:<?= htmlspecialchars($c['tech_phone']) ?>"
                                            ...
                                            <?php elseif ($c['available_tech']): ?>
                                                ...
                                                <div class="flex flex-col space-y-1">
                                                    <div class="flex items-center">
                                                        <span class="text-gray-500 dark:text-dark-text-secondary mr-2">Available
                                                            Technician:</span>
                                                        <span
                                                            class="font-medium text-gray-800 dark:text-dark-text-primary tech-name"><?= htmlspecialchars($tech_name) ?></span>
                                                    </div>
                                                    ...
                                                    <div class="flex items-center">
                                                        <a href="tel:<?= htmlspecialchars($tech_phone) ?>"
                                                            class="inline-flex items-center text-blue-600 dark:text-blue-400 hover:underline">
                                                            <span class="material-icons text-base mr-1">phone</span>Call
                                                        </a>
                                                    </div>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php if ($c['total_techs'] > 0): ?>
                                                    ...
                                                    <div class="flex flex-col space-y-1">
                                                        <div class="flex items-center">
                                                            <span
                                                                class="text-gray-500 dark:text-dark-text-secondary mr-2">Technician:</span>
                                                            <span
                                                                class="font-medium text-gray-800 dark:text-dark-text-primary tech-name"><?= htmlspecialchars($offline_tech_name) ?></span>
                                                        </div>
                                                        ...
                                                        <?php if ($offline_tech_phone): ?>
                                                            <div class="flex items-center">
                                                                <a href="tel:<?= htmlspecialchars($offline_tech_phone) ?>"
                                                                    class="inline-flex items-center text-blue-600 dark:text-blue-400 hover:underline">
                                                                    <span class="material-icons text-base mr-1">phone</span>Call
                                                                </a>
                                                            </div>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <div class="flex flex-col space-y-1">
                                                        ...
                                                        <div class="flex items-center">
                                                            <span class="text-xs text-orange-600 dark:text-orange-400">(Will be assigned
                                                                when available)</span>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                        ...
                                        <div class="flex space-x-3 mt-2">
                                            <button onclick="showQRModal('<?= htmlspecialchars($c['token']) ?>')"
                                                class="flex items-center px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-800 transition">
                                                <span class="material-icons text-base mr-1">qr_code_2</span>QR
                                            </button>
                                            <?php if ($c['status'] === 'pending'): ?>
                                                <button onclick="deleteComplaint('<?= htmlspecialchars($c['token']) ?>')"
                                                    class="flex items-center px-3 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-lg hover:bg-red-200 dark:hover:bg-red-800 transition">
                    ...
                    <?php else: ?>
                        <div class="text-center py-12">
                            <span
                                class="material-icons text-gray-400 dark:text-dark-text-secondary text-4xl mb-3">inbox</span>
                            <h3 class="text-lg font-medium text-gray-900 dark:text-dark-text-primary mb-2">No complaints yet
                            </h3>
                            <p class="text-sm text-gray-500 dark:text-dark-text-secondary">Submit your first complaint to
                                get started</p>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm p-4 mb-4">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-dark-text-primary mb-2">Recent Activity
                    </h3>
                    <ul class="space-y-2">
                        <?php foreach ($recent_activity as $act): ?>
                            <li class="flex items-center space-x-3">
                                ...
                                elseif ($act['status'] === 'pending')
                                    echo 'text-yellow-500 animate-pulse';
                                else
                                    echo 'text-blue-500';
                                ?>">fiber_manual_record</span>
                                <span class="text-sm text-gray-700 dark:text-dark-text-secondary">
                                    <?= htmlspecialchars(ucfirst($act['category'])) ?> complaint
                                    <b><?= htmlspecialchars($act['status']) ?></b> on
                                    <?= date('M j, g:i A', strtotime($act['updated_at'])) ?>
                                </span>
                            </li>
                        <?php endforeach; ?>
                    </ul>
        ...
        <div class="bg-white dark:bg-dark-bg-secondary rounded-xl max-w-sm w-full p-6 shadow-2xl">
            <div class="flex justify-between items-center mb-4">
                ...
                <button onclick="closeQRModal()"
                    class="text-gray-400 dark:text-dark-text-secondary hover:text-gray-600 dark:hover:text-dark-text-primary p-1 rounded-full hover:bg-gray-100 dark:hover:bg-dark-bg-primary">
                    <span class="material-icons">close</span>
                </button>
            </div>
            <div id="qr-container" class="flex justify-center p-4 bg-gray-50 dark:bg-dark-bg-primary rounded-lg"></div>
            <p class="text-sm text-gray-500 dark:text-dark-text-secondary text-center mt-4">Show this QR code to the
                technician to get your complaint resolved</p>
        </div>
    </div>
    ...
    <div id="delete-modal"
        ...
        <div class="bg-white dark:bg-dark-bg-secondary rounded-xl max-w-sm w-full p-6 shadow-2xl">
            ...
            <p class="text-gray-600 dark:text-dark-text-secondary mb-6">Are you sure you want to delete this complaint?
                This action cannot be undone.</p>
            <div class="flex justify-end space-x-3">
                <button onclick="closeDeleteModal()"
                    class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-dark-text-secondary hover:bg-gray-100 dark:hover:bg-dark-bg-primary rounded-lg transition-colors">
                    Cancel
                </button>
    ...
    <div id="help-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div
            class="bg-white dark:bg-dark-bg-secondary rounded-xl max-w-2xl w-full p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="space-y-6">
                ...
                <!-- Quick Start Guide -->
                <div
                    class="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-4 rounded-lg border border-blue-100 dark:border-blue-800">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div
                        ...
                        <p class="text-yellow-800 dark:text-yellow-200 text-sm">
                            Share your ideas or feedback to help improve campus life! Visit the Suggestions section to
                            submit new suggestions or vote on others' ideas.
                        </p>
                    </div>
                ...
                <!-- Need Help? -->
                <div
                    class="bg-gray-50 dark:bg-gray-900/20 p-4 rounded-lg border border-gray-200 dark:border-gray-700 text-center">
                ...
                <!-- Developer Signature -->
                <div
                    class="text-center opacity-60 hover:opacity-100 transition-opacity duration-300 cursor-default select-none">
                    <div class="font-mono text-[11px] tracking-[0.3em] text-gray-400 dark:text-gray-500">
                        DEVELOPED BY
                    </div>
                    <div
                        class="font-mono text-[10px] tracking-[0.4em] text-transparent bg-clip-text bg-gradient-to-r from-gray-600 to-gray-400 dark:from-gray-400 dark:to-gray-600">
                        MR.HARKAMAL
                    </div>
                </div>
